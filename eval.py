...
def main():
    ...
    prename, tgtname, ocrname, srcname = '/nas_data/WTY/dataset/visualC3/valid/label/tgt_valid.txt', '/nas_data/WTY/dataset/visualC3/valid/label/tgt_valid.txt', 'result.txt', '/nas_data/WTY/dataset/visualC3/valid/label/src_valid.txt'
    ...
    print(calculate_metric(srcs, tgts, predicts, ocr_preds, "result_p.txt"))
